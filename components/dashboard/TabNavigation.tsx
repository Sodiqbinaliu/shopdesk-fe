        ...
        {tabs.map((tab) => {
          ...
          return (
            ...
            >
              ...
              >
                <span
                  className={isActive ? 'text-[#2A2A2A]' : 'text-[#83838b]'}
                >
                  {tab.name}
                </span>
                {tab.icon}
          ...
          <div className='w-full'>
            <div className='lg:px-2 gap-4 lg:gap-[19px] w-full absolute bottom-15 lg:bottom-3  lg:-right-160 xl:-right-175 rounded-bl-2xl lg:'>
              <div className='flex items-center gap-2 bg-white'>
                ...
                <button
                  className='bg-white text-[16px] lg:hidden gap-[6px] flex h-[48px] items-center justify-center text-black p-3.5 rounded-xl border border-gray-500'
                  onClick={openExportModal}
                >
                  <Upload className='size-[18px]' />
                </button>
