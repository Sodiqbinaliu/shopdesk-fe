          ...
          <div className='lg:p-[20px]'>
            <div className='flex  flex-row lg:gap-4 mb-6 overflow-x-auto md:grid md:grid-cols-4 md:overflow-visible scrollbar-hide'>
              {metrics.map((metric, index) => (
                <div
                  key={index}
                  className='bg-white  min-w-[196px] mx-3 lg:mx-0 lg:mt-0 mt-4 border flex flex-col rounded-xl shadow'
                >
                  <div className='flex items-center w-full gap-2 lg:gap-[12px] pt-5 pb-5 pl-3'>
                    ...
                    <h2 className='text-[14px] lg:text-[16px] font-medium text-gray-800'>
                      {metric.title}
                    </h2>
                  </div>
                      ...
                      return (
                        <>
                          ...
                          <p className='text-xs mt-1'>
                            <span
                              className={`px-2 py-1 rounded-xl ${isPositive ? 'bg-green-50' : 'bg-red-50'} ${colorClass}`}
                            >
