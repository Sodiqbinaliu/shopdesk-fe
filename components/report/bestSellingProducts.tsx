    ...
    <div className='mt-6'>
      <div className='bg-white p-4 lg:rounded-xl shadow'>
        ...
        <div className='flex justify-between bg-white shadow-lg py-2.5 px-2.5 items-center mt-4 lg:hidden'>
          <button className='text-sm border text-grey-600 p-2.5 rounded-[10px]'>
            Previous
          </button>
        ...
        <table className='w-full text-left border'>
          <thead className='pt-3'>
            <tr className='bg-gray-100 text-[12px] pb-4 pt-2'>
              ...
              <th className='table-cell-padding text-gray-600 hidden lg:table-cell'>
                Remaining Qty
              </th>
              <th className='table-cell-padding text-gray-600 hidden lg:table-cell'>
                Turnover
              ...
              filteredProducts.map((product) => (
                <tr key={product.id}>
                  ...
                  <td className='table-object-padding hidden lg:table-cell'>
                    {product.available_quantity || 0} Pieces
                  </td>
                  <td className='table-object-padding hidden lg:table-cell'>
                    ₦{product.turnover?.toLocaleString() || 'N/A'}
                  </td>
                  <td className='table-object-padding text-green-600 hidden lg:table-cell'>
                    {product.growth || '0%'}
                  </td>
                  <td className='table-object-padding hidden lg:table-cell'>
