    ...
    datasets: [
      {
        ...
        data: [
          0, 130000, 120000, 120000, 125000, 130000, 150000, 155000, 130000,
          160000, 190000, 230000,
        ],
        borderColor: '#3B82F6',
      ...
      },
      {
        ...
        data: [
          0, 100000, 90000, 90000, 95000, 100000, 120000, 125000, 110000,
          130000, 160000, 200000,
        ],
        borderColor: '#000000',
      ...
      <div className='flex  items-start gap-4 justify-between'>
        ...
        <div className='flex lg:gap-8 lg:flex-row flex-col'>
          <div className='flex justify-center gap-2.5 items-center'>
            ...
            <p className='text-[8px] lg:text-[12px] text-gray-500'>
      ...
      {(() => {
        ...
        return (
          <div className='mb-[21px]'>
            <h3 className='text-2xl lg:text-[32px] text-[#111827] mt-2'>
              {metrics[0]?.value || '₦2,300,125'}
            </h3>
            <p
              className={`text-xs px-2 py-1 rounded-xl inline-block mt-1 lg:mt-0 ${isPositive ? 'bg-green-50' : 'bg-red-50'} ${colorClass}`}
            >
