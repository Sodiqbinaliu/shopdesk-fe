...
const ExportModal: React.FC<ExportModalProps> = ({ isOpen, onClose }) => {
  ...
  if (width > 640)
    return (
      ...
      >
        <div
          className='bg-white rounded-lg shadow-lg w-full max-w-[611px] flex flex-col gap-[28px] pt-[24px]'
          ...
          <div className='gap-[28px] flex flex-col'>
            <div className='flex gap-[16px] items-start justify-center'>
              ...
              <div className='flex flex-col h-full'>
                <h1 className='font-circular-medium text-[20px] sm:text-[24px] text-left'>
                  Export
                </h1>
                <p className='text-[18px] font-light text-[#717171]'>
                  Fill in your email details to download your expenses.
                </p>
              </div>
              <div className='flex'>
                <button
              ...
              <div className='flex flex-col gap-[20px] px-[24px]'>
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent className='max-h-60 w-full md:w-[562px] overflow-y-auto'>
                    <DropdownMenuItem
                      onClick={() => setSelectedDataType('Sales Transaction')}
                    >
                      Sales Transaction
                    </DropdownMenuItem>
                    <DropdownMenuItem
                      onClick={() => setSelectedDataType('Top Selling Product')}
                    >
                      Top Selling Product
                    </DropdownMenuItem>
                    <DropdownMenuItem
                      onClick={() =>
                        setSelectedDataType('Profit and Loss Summary')
                      }
                    >
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    ...
                    >
                      <div className='flex items-center gap-2'>
                        <span
                          className={`text-[16px] font-circular-normal ${selectedDateRange ? 'text-black' : 'text-[#B8B8B8]'}`}
                        >
                  ...
                  <DropdownMenuContent className='max-h-60 w-full md:w-[562px] overflow-y-auto'>
                    ...
                    <DropdownMenuItem
                      onClick={() => setSelectedDateRange('Custom range')}
                    >
                      Custom range
                    </DropdownMenuItem>
                  </DropdownMenuContent>
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    ...
                    >
                      <div className='flex items-center gap-2'>
                        <span
                          className={`text-[16px] font-circular-normal ${selectedFormat ? 'text-black' : 'text-[#B8B8B8]'}`}
                        >
  ...
  return (
    <Drawer isOpen={isOpen} onClose={handleClose}>
      <div
        className={`bg-white rounded-lg  w-full max-w-[611px] flex flex-col gap-[28px] pt-[24px] transition-all duration-500 ${animationClass}`}
        onClick={(e) => e.stopPropagation()}
      >
        <div className='gap-[28px] flex flex-col'>
          ...
          <div className='pb-[55px] flex'>
            <p className='text-[18px] text-center font-light text-[#717171]'>
              Fill in your email details to download your expenses.
            </p>
          </div>
          <form onSubmit={handleSubmit} className='flex flex-col gap-[20px]'>
