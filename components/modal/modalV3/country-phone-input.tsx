...
const CountryPhoneInput: React.FC<CountryPhoneInputProps> = ({
  ...
  return (
    <div className='flex-1'>
      <div
        className={`flex px-4 py-1 text-[#B8B8B8] relative border border-[#DEDEDE] rounded-[9px] text-base focus-within:border-green-500 focus-within:bg-white transition-colors ${className}`}
      >
        <div
