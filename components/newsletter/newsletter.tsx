  ...
  return (
    <div className="bg-green-50 px-4 lg:px-5 py-5">
        ...
        <div className='flex flex-col px-4 lg:px-[38px] pb-6 pt-[78px] rounded-xl justify-center items-center bg-white'>
            ...
            <h1 className='text-2xl lg:text-5xl font-bold'>Introducing Sales Tracking</h1>
            </div>
        <div className='flex flex-col justify-start items-start w-full mt-10 lg:mt-20 mb-5'>
            <p className='text-[16px] lg:text-2xl font-normal'>Hi, Emeka & Sons</p>
            <p className='text-[16px] lg:text-2xl font-normal mt-6'>Monitor your sales in real-time and unlock actionable insights to boost your business performance</p>
            <p className='text-[16px] lg:text-2xl font-normal lg:w-[1200px]'>Our new Sales Tracking feature provides a complete view of your revenue streams, best-selling products, and performance trends. Stay ahead by making informed decisions based on real-time data.</p>
        </div>
        <div>
                <Image
        ...
        <div  className='flex flex-col items-start justify-start mt-4 lg:mt-[65px] w-full'>
            <div className='flex flex-col items-start justify-start w-full'>
                <h2 className='text-[18px] lg:text-[32px] font-medium'>Key Benefits </h2>
            <div>
                <p className='text-[16px] lg:text-[24px] font-normal mt-6'>🚀 <span className='font-black'>Instant Recording &ndash;</span>Every transaction is captured in real time, ensuring accurate data tracking.</p>
            </div>
            <div>
                <p className='text-[16px] lg:text-[24px] font-normal mt-6'>📦 <span className='font-black'>Dynamic View Toggle &ndash;</span> Easily switch between &lsquo;show sales&rsquo; and &lsquo;show profits&rsquo; to view the metrics that matter most to you</p>
            </div>
            <div>
                <p className='text-[16px] lg:text-[24px] font-normal mt-6'>💼 <span className='font-black'>Seamless Sales Management &ndash;</span>  Track and optimize your business.</p>
            </div>
            <div className='mt-10'>
                <Button>
                    Learn More
            ...
            <div>
                <p className='text-[16px] lg:text-[24px] font-normal mt-6'>Try it now and boost your business insight.</p>
                <p className='text-[16px] lg:text-[24px] font-normal mt-6'>Thank you for choosing Shopdesk.</p>
                <p className='text-[16px] lg:text-[24px] font-normal mt-6'>Best regards,</p>
                <p className='text-[16px] lg:text-[24px] font-normal text-green-600'>Shopdesk team.</p>
            </div>
        </div>
        </div>
        </div>
