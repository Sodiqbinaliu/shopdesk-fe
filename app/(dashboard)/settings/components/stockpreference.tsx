...
const StockPreference = () => {
        ...
        {isOpen && (
          <div className='absolute right-0 w-[239px] bg-white border border-[#e9eaeb] rounded-[12px] mt-1 z-10 overflow-hidden'>
            {options.map((option) => (
              <div
                key={option.value}
                className={`w-[239px] h-[52px] px-4 py-4 border-b border-[#e9eaeb] last:border-b-0 font-circular-light text-[#535862] text-base leading-5 font-[400] cursor-pointer hover:bg-[#E9EEF3] ${
                  value === option.value ? 'bg-[#E9EEF3]' : ''
                }`}
                onClick={() => {
  ...
  const ToggleSwitch = ({
    ...
    <label className='relative inline-flex items-center cursor-pointer'>
      ...
      />
      <div className='w-11 h-6 bg-gray-200 rounded-full peer peer-checked:bg-[#009A49] mr-76 transition-colors' />
            ...
            <div className='flex flex-col sm:flex-row border-b-2 border-[#e9eaeb] w-full h-[249px] gap-16'>
              ...
              <div className='flex flex-col gap-2 flex-1'>
                ...
                <p className='font-circular-light text-[#535862] text-xs leading-5 font-[300] max-w-[358px]'>
                  Changing the store currency will update how prices are
                  displayed but will not automatically convert existing product
                  prices. Ensure you update your pricing accordingly.
                </p>
              </div>
            </div>
                  ...
                  {[
                    ...
                    >
                      <input
                        ...
                        name='paymentMethod'
                        checked={
                          preferences.paymentMethods?.[option.value] || false
                        }
            ...
            <div className='flex flex-col sm:flex-row border-b-2 border-[#e9eaeb] w-full max-w-[590px] h-[68px] justify-between pb-4'>
              ...
              <div className='flex flex-col flex-1'>
                <input
                  ...
                  onChange={(e) =>
                    dispatch(updateAccountDetails(e.target.value))
                  }
