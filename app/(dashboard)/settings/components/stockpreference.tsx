            ...
            <div className="flex flex-col sm:flex-row border-b-2 border-[#e9eaeb] w-full max-w-[590px] h-[114px] justify-between">
              ...
              <div className="flex flex-col gap-2 flex-1">
                <div className="flex flex-col gap-3 ml-16">
                  {[
                    { id: 'checkbox1', value: 'bankTransfer' as const, label: 'Bank Transfer' },
                    { id: 'checkbox2', value: 'paypal' as const, label: 'PayPal' },
                    { id: 'checkbox3', value: 'stripe' as const, label: 'Stripe' },
                  ].map((option) => (
                    <div key={option.id} className="flex flex-row items-center gap-3">
                      <input
                        ...
                        id={option.id}
                        name="paymentMethod"
                        checked={preferences.paymentMethods?.[option.value] || false}
