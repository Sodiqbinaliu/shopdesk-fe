...
export const FeatureCard: React.FC<FeatureCardProps> = ({
  ...
  >
    ...
    <h3 className='text-[20px] leading-6 font-medium text-[#2A2A2A] text-center'>
      {title}
    </h3>
...
const Features = () => {
  return (
    <div
      id='features'
      className='mx-auto max-w-[1198px] px-5 my-16 min-[600px]:px-10'
    >
      <h2
      ...
      <div className='mx-auto max-w[876px] text-center my-10 space-y-6'>
        <div className='space-y-2'>
          <h2 className='text-[24px] md:text-[36px] font-medium leading-[44px] text-[#2A2A2A]'>
            Stay Ahead – Manage Your Stock with Ease!
          </h2>
          <p className='text-[#717171] text-[20px] leading-[30px]'>
            Join Shopdesk today and take control of your inventory!
          </p>
        </div>
        <Button className='w-2/4 p-8 rounded-[12px] text-lg h-[62px]'>
          Join Now <ArrowRight />
        </Button>
      </div>
    </div>
