      ...
      <section>
        ...
        <div className=' flex flex-col items-center gap-6 pt-10 max-w-[1000px] mx-auto px-5 min-[600px]:px-10'>
          <h1 className='text-[clamp(36px,_6vw,_60px)] max-w-[947px] leading-14 font-circular-bold md:leading-16 text-center'>
            ...
            <span className='text-green-300'>Sales & Inventory</span> Software
            for Retailers
          </h1>
          ...
          <Link
            href='/sign-up'
            className='mt-6 bg-black text-white py-3 px-6 rounded-lg text-lg font-medium hover:bg-gray-900'
          >
            Start for Free
          </Link>
        </div>
            ...
            >
              ...
              <ul className='flex flex-col gap-6 leading-6 mt-10 text-left max-w-2xl'>
                <li className='flex items-center gap-2 text-base'>
                  ...
                  Track inventory in real-time – Know what’s in stock and when
                  to restock.
                </li>
                <li className='flex items-center gap-2 text-base'>
                  <Image src={Check} height={24} width={24} alt='check-icon' />
                  Record and manage sales effortlessly – Log every transaction
                  with ease.
                </li>
                <li className='flex items-center gap-2 text-base'>
                  <Image src={Check} height={24} width={24} alt='check-icon' />
                  Generate instant receipts – Print or send digital receipts in
                  seconds.
                </li>
                <li className='flex items-center gap-2 text-base'>
                  <Image src={Check} height={24} width={24} alt='check-icon' />
                  View sales history and reports – Gain insights into your
                  business performance.
                </li>
                <li className='flex items-center gap-2 text-base'>
                  <Image src={Check} height={24} width={24} alt='check-icon' />
                  Access your data anytime, anywhere – Manage your business from
                  any device.
                </li>
              </ul>
            </div>
        ...
        <div className='bg-[#19A45B] text-white py-16 flex flex-col items-center text-center px-4 my-9'>
          <span className='bg-[#0000001A] text-sm text-white px-4 py-2 rounded-full mb-4'>
            Get Early Access &ndash; Only{' '}
            <span className='text-black'>50 Spots</span> Left!
          </span>
