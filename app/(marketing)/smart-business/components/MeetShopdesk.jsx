        ...
        >
          ...
          >
            <p className='text-base md:text-xl lg:text-2xl text-gray-500'>
              Shopdesk helps business owners manage inventory, track sales and
              save money while at it! Imagine focusing on selling more, pleasing
              your customers, and growing your brand without stressing over
              losing money and customers or inventory report. Designed for small
              and medium business owners, no tech skills required! With
              Shopdesk, a Simpler, More Profitable Business Awaits You!
            </p>
          </div>
