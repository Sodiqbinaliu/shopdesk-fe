      ...
      <div className=' w-full md:max-w-[958px] mx-auto flex flex-col gap-5 mt-14'>
        <section className='w-full flex flex-col gap-4'>
          ...
          <p>
            ...
            unsatisfied customers and lost sales. That&apos;s where Shopdesk
            comes in—providing a seamless order management system that keeps
            your business running smoothly.
          </p>
          <p>
            Whether you&apos;re handling a few orders a day or managing a
            high-volume store, a structured, automated approach can save time,
            reduce errors, and improve customer satisfaction. Here&apos;s how
            Shopdesk makes order management effortless.
          </p>
        </section>
