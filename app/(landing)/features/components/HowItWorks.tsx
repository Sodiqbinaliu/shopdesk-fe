  ...
  const steps = [
    {
      ...
      description:
        'Create your Shopdeck account and add your products, pricing, and business details.',
    },
    {
      number: '02',
      title: 'Sales and Stock Management',
      description:
        'Process sales quickly while Shopdeck automatically updates your inventory in real-time.',
    },
    {
      number: '03',
          ...
          <div className='flex flex-col space-y-10'>
            {steps.map((step, index) => (
              ...
              >
                ...
                {/* Number Circle */}
                <div
                  className={`w-16 h-16 md:w-20 md:h-20 rounded-full border-4 flex items-center justify-center ${
                    activeStep === index
